...
def main():
    if len(sys.argv) != 5:
        print("Erro, use: python TSPd-parte1.1.py arquivo tipo k v")
        exit(-1)
    ...
    while i < qtd_cidades:
        ...
        valor_total = valor_total + melhor_distancia
    ...
    solucao.append(0)
    valor_total = valor_total + distancias[solucao[len(solucao) - 2]][0]
